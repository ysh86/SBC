...
void main(void) {
    ...
    // /ABORT (RE0) output pin
    ANSELE0 = 0;	// Disable analog function
    LATE0 = 1;		// ABORT inactive (High)
...
//  CLCIN1PPS
    ...
    CLCIN4PPS = 0x03; // CLCIN4PPS <- RA3 <- R/W
//  CLCIN5PPS
    ...
    CLCnSEL0 = 2;    // CLCIN2PPS <- A15
    CLCnSEL1 = 3;    // CLCIN3PPS <- A14
    CLCnSEL2 = 4;    // CLCIN4PPS <- R/W
    CLCnSEL3 = 127;  // N/C

    // $c,d,e,fxxx (Read only)
    CLCnGLS0 = 0x02; // A15=1
    CLCnGLS1 = 0x08; // A14=1
    CLCnGLS2 = 0x20; // R
    CLCnGLS3 = 0x40; // !0 =1
